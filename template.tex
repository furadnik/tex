...
\usepackage{amsmath,amssymb,amsthm,textcomp,enumitem,thm-restate}
\usepackage{listings}
\usepackage{parskip}
...
\newenvironment{invariants} {\begin{enumerate}[label=(I\theenumi)]} {\end{enumerate}}
...
\def\rvec#1{\textbf{#1}}
\def\rmat#1{\textbf{#1}}
\def\veci#1#2{\vec{#1}_{\!#2}}
\def\mat#1{\textbf{\textit{#1}}}
\def\mati#1#2{\mat{#1}_{#2}}
\def\matii#1#2#3{\mat{#1}_{\!#2,#3}}
\def\trans#1{#1^{\tr}}
\def\tmat#1{\trans{\mat{#1}}}
\def\tvec#1{\trans{\vec{#1}}}
